...
class ZedCameraWrapper:
    ...
    def __init__(self, fps: int = 15, resolution=sl.RESOLUTION.HD720) -> None:
        ...
        self.output_resolution = sl.Resolution(512, 288)
